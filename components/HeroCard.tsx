  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 md:px-10">
        <h1
          ref={titleRef}
          className={`text-3xl md:text-5xl font-bold text-white mb-4 ${ralway.className}`}
        >
          {title}
        </h1>
        <p
          ref={descriptionRef}
          className={`text-lg md:text-xl text-white max-w-2xl mx-auto font-normal ${IBM.className}`}
        >
          {subheading}
        </p>
      </div>
