  ...
  return (
    <div className="bg-whiteBackground rounded-lg shadow-lg mt-2 w-full h-full">
      ...
      <div className="flex flex-col px-4 space-y-3 items-start py-4">
        <h3
          className={`font-bold text-lg md:text-xl text-left ${ralway.className}`}
        >
          {program.title}
        </h3>
        <p
          className={`text-paratext text-sm md:text-base mb-4 text-justify font-normal ${IBM.className}`}
        >
          {program.description}
        </p>
